...
//                             className="bg-white rounded-[15px] p-8 shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col justify-between h-96 relative overflow-hidden group"
//                         >
//                             {/* Illustration Area */}
//                             <div className="flex-1 flex items-center justify-center relative">
//                                 {/* Custom SVG composition for Target/Dart */}
