...
//         buttons: [
//             { text: "WhatsApp Now", href: "/contact", style: "primary" },
...
//         // 🚨 MODIFIED: buttonText replaced with an array of button objects
//         buttons: [
//             { text: "Browse Sale", href: "/contact", style: "primary" },
//         ],
//         type: "image" // Type is 'video' for MP4
//     },
// ];
...
// // --- 1. Data Configuration ---
// // Added mediaSrcMobile to hold a different asset for smaller screens.
// const SLIDES = [
//     // {
//     //     id: 1,
//     //     theme: "olive",

//     //     mediaSrcDesktop: "/dummy-image/vecteezy_ai-generated-grocery-cart-full-of-shopping-copy-space_39898959.jpg",

//     //     mediaSrcMobile: "/dummy-image/vecteezy_ai-generated-grocery-cart-full-of-shopping-copy-space_39898959.jpg",
//     //     textColor: "text-white",
//     //     eyebrow: "Established 2009 • Dubai, UAE",
//     //     title: ["Dubai's One-Stop", "FMCG Hub"],
//     //     description: "MKT General Trading connects food, cleaning and household brands from Dubai to importers, distributors and wholesalers across the GCC, Africa and beyond with mixed-container solutions, competitive pricing and reliable export support.",
...
//         mediaSrcDesktop: "https://herbyo-store-demo.myshopify.com/cdn/shop/files/slide1.1.jpg?v=1637223275",
//         // Mobile Source (Placeholder - should be a more optimized/vertical asset)
//         mediaSrcMobile: "https://herbyo-store-demo.myshopify.com/cdn/shop/files/slide1.1.jpg?v=1637223275", // Use a different, smaller, or vertical image here
//         textColor: "text-white",
//         eyebrow: "Established 2009 • Dubai, UAE",
//         title: ["Your FMCG Trading ", "Partner in Dubai"],
//         description: "We source, consolidate and ship quality food, cleaning and household products to importers and distributors across the GCC, Africa and beyond.",
...
//         theme: "photo",
//         // Desktop/Tablet Source (Original)
//         mediaSrcDesktop: "/dummy-image/Gemini_Generated_Image_bepfdobepfdobepf.png",
//         // Mobile Source (Placeholder - should be a more optimized/vertical asset)
...
// export default function HeroSlider() {
//     const [currentIndex, setCurrentIndex] = useState(0);
//     const { width } = useWindowSize(); // Use the hook to get current width
...
//         mediaSrcDesktop: "/hero/mktbanner2d.png",

//         mediaSrcMobile: "/hero/mkt2bannermobileview.png",
//         textColor: "text-white",
//         eyebrow: "Established 2009 • Dubai, UAE",
//         title: ["Dubai's One-Stop", "FMCG Hub"],
//         description: "MKT General Trading connects food, cleaning and household brands from Dubai to importers, distributors and wholesalers across the GCC, Africa and beyond with mixed-container solutions, competitive pricing and reliable export support.",
...
//         theme: "teal",
//         // Desktop/Tablet Source (Original)
//         mediaSrcDesktop: "/hero/mktmobileview.png",
...
//         description: "MKT General Trading connects food, cleaning and household brands from Dubai to importers, distributors and wholesalers across the GCC, Africa and beyond with mixed-container solutions, competitive pricing and reliable export support.",
//         buttons: [
//             { text: "Browse Sale", href: "/category", style: "primary" },
//         ],
//         type: "image"
//     },
// ];
...
//         theme: "teal",
//         // Desktop/Tablet Source (Original)
//         mediaSrcDesktop: "/hero/mktdesk.png",
...
//         }, AUTOPLAY_DELAY);
//         return () => clearInterval(timer);
//     }, [currentIndex]); // Note: If you don't want the interval to restart on every slide change, 
//     // you can remove currentIndex from dependencies and use the functional update form:
//     // setInterval(() => setCurrentIndex((prev) => (prev + 1) % SLIDES.length), AUTOPLAY_DELAY);
