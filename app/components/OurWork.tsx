...
// // In a real Next.js app, you'd import Image, but for this component,
// // we'll stick to the original's background-image usage.
...
// // Images are assumed to be in the /public/images/ folder
...
// // --- Sub-component for a single Portfolio Item ---
...
//                 {/* Image */}
//                 <div
//                     className={`w-full md:w-5/12 bg-cover bg-center min-h-[400px] lg:min-h-[500px] ${isRightAligned ? 'md:order-last' : ''
//                         }`}
...
//                                     {item.category}
//                                 </span>
//                                 <h2 className="text-2xl lg:text-3xl font-medium text-gray-900 my-2">
